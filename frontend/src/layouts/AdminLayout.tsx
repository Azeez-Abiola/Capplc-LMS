...
export default function AdminLayout() {
  return (
    <div className="min-h-screen flex flex-col bg-[#F8F9FA] pt-20">
        ...
        <div className="max-w-[1440px] mx-auto px-4 md:px-10 flex flex-col md:flex-row justify-between items-center gap-8 md:gap-10">
           <div className="flex items-center gap-5 group">
              ...
              <div className="space-y-1">
                 <p className="text-xs font-bold text-secondary-900 tracking-widest leading-none">Admin dashboard</p>
                 <p className="text-[10px] font-bold text-slate-400 tracking-[0.2em]">Cap Plc Business Pro platform</p>
              </div>
           </div>
           <div className="text-right space-y-2">
              <p className="text-[10px] font-bold text-slate-300 tracking-[0.5em]">Cap Plc 2026</p>
